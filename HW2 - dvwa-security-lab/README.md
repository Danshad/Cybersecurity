...
- **Filesystem isolation**: Container has its own isolated filesystem separate from the host
- **Network isolation**: Container has its own IP address (172.17.0.2) and network stack
